...
from advent_of_code_2023.day4 import count_points_in_card, number_cards_won, parse_card
...
@pytest.mark.parametrize(
    "card,card_serial_number,winning_numbers,card_numbers",
    [
        (
...
def test_parse_cards(
    ...
    assert parse_card(card) == (card_serial_number, winning_numbers, card_numbers)
